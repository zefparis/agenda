      ...
      >
        <div className="relative flex items-center gap-2">
          <input
            ...
            className="flex-1 px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 text-sm sm:text-base rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none transition-colors"
            disabled={isLoading}
          />
